...
@NgModule({
  declarations: [
    ...
    FormComponent, DetailsComponent,
    AddComponent, LoginComponent,
    YesNoPipe,  StatusPipe,
    FacultyComponent, AllFacultyComponent,
    AddFacultyComponent,RolesComponent,
     EditfacultyComponent, AllStudentsComponent,
      OrgStudentsComponent, AddStudentsComponent,
       EditStudentsComponent, StudentDetailsComponent,
        LogoutComponent, HeaderComponent, SignupComponent,
  ],
  imports: [
    BrowserModule,    AppRoutingModule,
    HttpClientModule,    ReactiveFormsModule,
    FormsModule,    OAuthModule.forRoot(),Ng2SearchPipeModule,
    BrowserAnimationsModule,    NgbModule,NgxPaginationModule,
    NgbAlertModule,    CommonModule,
    TabViewModule,    TabMenuModule,
    SidebarModule,    ButtonModule,
    TableModule, ProgressBarModule, CarouselModule,
    ToastModule, PanelModule, MessagesModule,
     MessageModule, DropdownModule, CalendarModule,
